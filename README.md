...
<img src="https://github.com/user-attachments/assets/76906dbc-343d-4267-ace5-048d428fff42" width="20px"> Smart CareerBoost AI is your all-in-one tool to analyze, optimize, and craft resumes that stand out, helping you land your dream job.  
</div>
...
Follow the steps below to set up and run the **Smart CareerBoost AI** on your local machine.
...
To enable access to the **Gemini API** used by the CareerBoost AI, you need to set up environment variables securely.
...
### What's Happening? 🤔  
If you're using the **Browser's (e.g., Chrome, Edge, etc.) Autofill** feature to quickly fill out your **Name**, **Email**, and **Phone** details in our **Smart CareerBoost AI**, you might encounter this error in generating Resume:  
